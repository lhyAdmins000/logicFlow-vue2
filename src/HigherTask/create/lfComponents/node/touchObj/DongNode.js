...
import Vue from 'vue';
// eslint-disable-next-line
import DONGNode from './vComp/DONGNode.vue';
// eslint-disable-next-line
...
const width = 342;
const height = 95;
// class DongNodeModel extends RectResize.model {
//   initNodeData(data) {
...
//     this.sourceRules = [
//       selfValidation,
//       sourceNodeWithMultipleValid('咚咚后置只能连接一个节点', { graphModel: this.graphModel, id: this.id }),
//       {
//         message: '咚咚后置只允许连接结束节点',
...
//     // 作为目标
//    this.targetRules = [
//     targetNodeWithMultipleValid('咚咚前置只能连接一个节点！', { id: this.id, graphModel: this.graphModel }),
//   ];
//   }
...
// // 自定义圆角边框
// class DongNodeView extends RectResize.view {
//   getShape() {
...
//   }
// }
class DongNodeView extends HtmlNode {
  constructor(props) {
    super(props);
...
class DongNodeModel extends HtmlNodeModel {
  setAttributes() {
    this.width = width;
    this.height = height;
