...
import Vue from 'vue';
// eslint-disable-next-line
import GoalCrowd from './vComp/GoalCrowd.vue';
// eslint-disable-next-line
import { HtmlNode, HtmlNodeModel } from "@logicflow/core";
import selfValidation, { sourceNodeWithMultipleValid, targetNodeWithMultipleValid } from '../../tools/valid';

// 后置节点集合
export const width = 237;
export const height = 88;
const afterNodesRule = ['DONGDONG', 'SMS'];
// class GoalCrowdModel extends RectResize.model {
//   initNodeData(data) {
...
//       selfValidation,
//       {
//         message: '目标人群节点的后置节点只能是咚咚、短信节点！',
//         validate: (_, targetNode) => afterNodesRule.includes(targetNode.type),
//       },
//     ];

//     // 作为目标
//     this.targetRules = [
//       targetNodeWithMultipleValid('目标人群前置只能连接一个节点！', { id: this.id, graphModel: this.graphModel }),
//     ];
//   }
...
// // 自定义圆角边框
// class GoalCrowdView extends RectResize.view {
//   getShape() {
...
class GoalCrowdView extends HtmlNode {
  constructor(props) {
    super(props);
...
class GoalCrowdModel extends HtmlNodeModel {
  setAttributes() {
    this.width = width;
    this.height = height;
  ...
  initNodeData(data) {
    ...
    this.sourceRules = [
      ...
      sourceNodeWithMultipleValid('目标人群后置只能连接一个节点！', { id: this.id, graphModel: this.graphModel }),
    ];
