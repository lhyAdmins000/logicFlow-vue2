...
import Vue from 'vue';
// eslint-disable-next-line
import ComponentNode from './vComp/SpreadNode.vue';
// eslint-disable-next-line
...
class SpreadNodeView extends HtmlNode {
  constructor(props) {
    super(props);
...
class SpreadNodeModel extends HtmlNodeModel {
  setAttributes() {
    this.width = width;
    this.height = height;
  ...
  initNodeData(data) {
    ...
    // 作为目标
    this.targetRules = [
      targetNodeWithMultipleValid('智能扩散前置只能连接一个节点！', { id: this.id, graphModel: this.graphModel }),
    ];
  }
