...
import Vue from 'vue';
// eslint-disable-next-line
import ComponentNode from './vComp/UniqueNode.vue';
// eslint-disable-next-line
import { HtmlNode, HtmlNodeModel, h } from "@logicflow/core";
import selfValidation, { sourceNodesLenthMaxValid } from '../../tools/valid';
...
class UniqueNodeView extends HtmlNode {
  constructor(props) {
    super(props);
...
class UniqueNodeModel extends HtmlNodeModel {
  setAttributes() {
    this.width = width;
    this.height = height;
  ...
  getNodeStyle () {
    ...
    this.targetRules = [
      ...
      {
        message: '排重前置节点只能为单个人群包、批量人群包、合并、拆分、排重、交集、排除',
